 ...
 * Esta tela NÃO redeclara chrome — usa as classes do shell (adm-card, adm-table,
 * adm-pill, adm-btn, adm-flash, adm-modal, adm-field/adm-input) + um bloco curto
 * `adm-eq-*` para a grade da lista e o cadastro inline. Tokens da camada do totem
 * (--bg-*, --text-*, --*-primary, --gd-teal-*). Números com `gd-tabular`.
 * NENHUMA regra de negócio mudou (G4 + G5 + CRUD preservados) — só a pele.
 */
